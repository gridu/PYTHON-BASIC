...
if __name__ == '__main__':
    read_files("file_1.txt", "file_2.txt", "file_3.txt", res_file_path="/Users/tiasalmon/Documents/Python_Basics/python_basic/practice/3_python_testing/files/result.txt")
